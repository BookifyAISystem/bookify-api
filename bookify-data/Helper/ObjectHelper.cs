...
using ExplicitKeyAttribute = Dapper.Contrib.Extensions.ExplicitKeyAttribute;
		...
		public static string PrimaryKey<T>()
		{
			...
			foreach (PropertyInfo property in properties)
			{
				var attribute = Attribute.GetCustomAttribute(property, typeof(KeyAttribute))
					as KeyAttribute;
				var attribute2 = Attribute.GetCustomAttribute(property, typeof(ExplicitKeyAttribute))
				   as ExplicitKeyAttribute;

				if (attribute != null || attribute2 != null) // This property has a KeyAttribute
				{
